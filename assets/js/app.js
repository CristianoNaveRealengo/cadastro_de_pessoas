// ==============================================
// VARIÁVEIS GLOBAIS ICIAIS
// ==============================================

// Variável global para o serviço Firebase
...
function handleFormSubmit(e) {
	...
	const formData = {
		...
		fullName:
			(fullNameInput === null || fullNameInput === void 0
				? void 0
				: fullNameInput.value.trim()) || "",
		origin:
			(originSelect === null || originSelect === void 0
				? void 0
				: originSelect.value) || "",
		dob:
			(dobInput === null || dobInput === void 0
				? void 0
				: dobInput.value) || "",
		age:
			parseInt(
				(ageInput === null || ageInput === void 0
					? void 0
					: ageInput.value) || "0"
			) || 0,
		city:
			(citySelect === null || citySelect === void 0
				? void 0
				: citySelect.value) || "",
		neighborhood:
			(neighborhoodSelect === null || neighborhoodSelect === void 0
				? void 0
				: neighborhoodSelect.value) || "",
		education:
			(educationSelect === null || educationSelect === void 0
				? void 0
				: educationSelect.value) || "",
		status:
			(statusSelect === null || statusSelect === void 0
				? void 0
				: statusSelect.value) || "",
		referenceName:
			(referenceNameInput === null || referenceNameInput === void 0
				? void 0
				: referenceNameInput.value.trim()) || "",
		forwarding:
			(forwardingInput === null || forwardingInput === void 0
				? void 0
				: forwardingInput.value.trim()) || "",
		observation:
			(observationTextarea === null || observationTextarea === void 0
				? void 0
				: observationTextarea.value.trim()) || "",
...
function updateForwardingFilterOptions() {
	...
	const forwardings = new Set(
		appData.records.map((record) => record.forwarding).filter((f) => f)
	);
...
function clearSearchFilters() {
	...
	const searchCitySelect = document.getElementById("searchCity");
	const searchNeighborhoodSelect =
		document.getElementById("searchNeighborhood");
...
function getFilteredRecords() {
	...
	const nameFilter =
		(searchNameInput === null || searchNameInput === void 0
			? void 0
			: searchNameInput.value.toLowerCase()) || "";
	const cityFilter =
		(searchCitySelect === null || searchCitySelect === void 0
			? void 0
			: searchCitySelect.value) || "";
	const neighborhoodFilter =
		(searchNeighborhoodSelect === null ||
		searchNeighborhoodSelect === void 0
			? void 0
			: searchNeighborhoodSelect.value) || "";
	const originFilter =
		(searchOriginSelect === null || searchOriginSelect === void 0
			? void 0
			: searchOriginSelect.value) || "";
	const statusFilter =
		(searchStatusSelect === null || searchStatusSelect === void 0
			? void 0
			: searchStatusSelect.value) || "";
	const educationFilter =
		(searchEducationSelect === null || searchEducationSelect === void 0
			? void 0
			: searchEducationSelect.value) || "";
	const yearFilter =
		(searchYearSelect === null || searchYearSelect === void 0
			? void 0
			: searchYearSelect.value) || "";
	const forwardingFilter =
		(searchForwardingSelect === null || searchForwardingSelect === void 0
			? void 0
			: searchForwardingSelect.value) || "";
...
function saveChanges() {
	...
	appData.records[recordIndex] = Object.assign(
		Object.assign({}, appData.records[recordIndex]),
		{
			fullName:
				(editFullName === null || editFullName === void 0
					? void 0
					: editFullName.value) || "",
			origin:
				(editOrigin === null || editOrigin === void 0
					? void 0
					: editOrigin.value) || "",
			dob:
				(dobInput === null || dobInput === void 0
			...
			age: newAge,
			city:
				(editCity === null || editCity === void 0
					? void 0
					: editCity.value) || "",
			neighborhood:
				(editNeighborhood === null || editNeighborhood === void 0
					? void 0
					: editNeighborhood.value) || "",
			education:
				(editEducation === null || editEducation === void 0
					? void 0
					: editEducation.value) || "",
			status:
				(editStatus === null || editStatus === void 0
					? void 0
					: editStatus.value) || "",
			referenceName:
				(editReferenceName === null || editReferenceName === void 0
					? void 0
					: editReferenceName.value.trim()) || "",
			forwarding:
				(editForwarding === null || editForwarding === void 0
					? void 0
					: editForwarding.value.trim()) || "",
			observation:
				(editObservation === null || editObservation === void 0
					? void 0
					: editObservation.value.trim()) || "",
			timestamp: new Date().toISOString(),
		}
	);
	// Salva as alterações
