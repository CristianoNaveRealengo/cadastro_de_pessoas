...
export const firebaseConfig: FirebaseConfig = {
    ...
    authDomain: "cadastro-pessoas-xxxx.firebaseapp.com",
    projectId: "cadastro-pessoas-xxxx",
    storageBucket: "cadastro-pessoas-xxxx.appspot.com",
...
export const origins = ['MSE', 'MP', 'EP', 'EPT'] as const;
export const statuses = ['Em Análise', 'Contratado', 'Não Contratado'] as const;